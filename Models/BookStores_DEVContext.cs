...
{
    public partial class BookStores_DEVContext : DbContext
    {
        public BookStores_DEVContext()
        {
        }

        public BookStores_DEVContext(DbContextOptions<BookStores_DEVContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F222625A345C");
